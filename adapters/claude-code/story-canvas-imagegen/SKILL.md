...
Use this skill as the Claude Code image-generation adapter for the Story Canvas repository.
...
Use this when Claude Code itself or another external image agent should execute the generation.
