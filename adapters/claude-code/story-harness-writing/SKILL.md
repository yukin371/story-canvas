...
description: Structured Chinese fiction writing adapter for Claude Code. Use when Claude Code needs to plan, draft, revise, and review a long-form Chinese novel with the Story Canvas workflow. This skill combines writing-method guidance with CLI workflow routing, story-state awareness, volume closure, and quality gates.
---
...
Use this skill as the Claude Code writing adapter for the Story Canvas repository.
...
1. it tells Claude Code how to write
2. it tells Claude Code which CLI workflow to run
...
Before writing, Claude Code should know:
...
After writing, Claude Code should not stop at prose completion. It must loop through analysis, review, revision, and re-check.
